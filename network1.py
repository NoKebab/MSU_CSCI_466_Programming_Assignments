...
class Router:
    ...
    def __init__(self, name, cost_D, max_queue_size):
        ...
        self.rt_tbl_D = self.init_rt()  # {destination: {router: cost}}
    ...
    def print_routes(self):
        ...
        printed_routers = []
        for destination in self.rt_tbl_D:
            for router, cost in self.rt_tbl_D.get(destination).items():
                if not printed_routers.__contains__(router):
                    print('{}|  {}'.format(router, cost), end='| ')
                    printed_routers.append(router)
                else:
                    print(' {}'.format(cost), end='|')
        print()
        for _ in range(len(self.rt_tbl_D)):
            print(end="+----")
        print('+')
